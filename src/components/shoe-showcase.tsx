...
const allShoes: Shoe[] = PlaceHolderImages as Shoe[];
    ...
    <section id="products" className="py-16 md:py-24">
      <div className="container mx-auto max-w-7xl px-4">
        <div className="text-center mb-12">
          <h2 className="font-headline text-4xl font-bold tracking-tighter text-primary sm:text-5xl">Our Collection</h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-foreground/70">
            Discover shoes that are thoughtfully designed and meticulously crafted for every walk of life.
          </p>
        </div>
