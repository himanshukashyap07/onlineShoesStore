      ...
      <main className="flex-1 py-16 md:py-24">
        <div className="container mx-auto max-w-7xl px-4">
          <div className="text-center mb-12">
            <h1 className="font-headline text-5xl font-bold tracking-tighter text-primary sm:text-6xl">New Arrivals</h1>
            <p className="mx-auto mt-4 max-w-2xl text-lg text-foreground/70">
              Be the first to step out in our latest styles. Fresh from the design studio to your wardrobe.
            </p>
          </div>
