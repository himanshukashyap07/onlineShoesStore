...
const allShoes: Shoe[] = PlaceHolderImages.filter(s => s.category.includes('women'));
      ...
      <main className="flex-1 py-16 md:py-24">
        <div className="container mx-auto max-w-7xl px-4">
          <div className="text-center mb-12">
            <h1 className="font-headline text-5xl font-bold tracking-tighter text-primary sm:text-6xl">Women's Collection</h1>
            <p className="mx-auto mt-4 max-w-2xl text-lg text-foreground/70">
              Discover elegant and comfortable footwear for every occasion in our women's collection.
            </p>
          </div>
